...
compile endif -- WANT_TEXT_PROCS
      -- Ctrl+F1 is not definable in EPM:
      ...
      buildmenuitem menuname, 80, 8007, UPCASE_WORD_MENU__MSG,             'key 1 c+f1'UPCASE_WORD_MENUP__MSG, 0, mpfrom2short(HP_POPUP_UPCASEWORD, gray_if_space)
