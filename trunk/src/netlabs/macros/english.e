...
; MENU item.  Note that each prompt must start with \1.
   ...
   EDIT_BAR__MSG =        '~Edit '
     ...
     SWAP_CURSOR_MENU__MSG= 'S~wap cursor'
     CLIP_COPY_MENU__MSG =  '~Copy'
     CUT_MENU__MSG =        'Cu~t'
     PASTE_C_MENU__MSG =    '~Paste'
   ...
   OPTIONS_BAR__MSG         = '~Options '
     ...
     PROOF_MENU__MSG          = 'Proo~f'
     PROOF_WORD_MENU__MSG     = 'Proof ~word'
     DYNASPELL_MENU__MSG      = 'Auto-spellchec~k'
