...
DO 1
   ...
   */
   ...
   rcx = SysDestroyObject( NetlabsDir'\install\applyico.cmd')
   rcx = SysDestroyObject( NetlabsDir'\install\renudirs.cmd')
   rcx = SysDestroyObject( NetlabsDir'\install\remepm.cmd')
   rcx = SysDestroyObject( NetlabsDir'\install\nlsetup.exe')
